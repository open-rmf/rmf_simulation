...
breathe_projects = {
    'rmf_simulation': '_build/doxygen/xml'
}
breathe_default_project = 'rmf_simulation'

exhale_args = {
    'containmentFolder': './api',
    'rootFileName': 'rmf_simulation_root.rst',
    'rootFileTitle': 'rmf_simulation API',
    'doxygenStripFromPath': '../..',
    'createTreeView': True,
    'exhaleExecutesDoxygen': False,
    'exhaleDoxygenStdin': 'INPUT = ../rmf_robot_sim_common/include ../rmf_building_sim_common/include',
}
